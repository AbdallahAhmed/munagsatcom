        ...
        <div class="tab-content tab-content-bordered form-horizontal" style="padding-top:15px">
                ...
                <div class="form-group tooltip-demo">
                    ...
                    <div class="col-sm-8">
                        ...
                        <input type="text" name="meta[meta_title]"
                               value="<?php echo (Request::old('meta[meta_title]', $meta_title)) ?>"
                               class="form-control input-lg" id="meta_title"
                               placeholder="<?php echo Lang::get('seo::seo.meta_title'); ?>"/>
            ...
            <div class="tab-pane fade form-group" id="advanced-tab">
                ...
                <div class="form-group" style="margin-top:20px">
                    ...
                    <div class="col-sm-7">
                        ...
                        <input type="text" name="meta[canonical_url]"
                               value="<?php echo string_sanitize(Request::old('meta[canonical_url]', $link)) ?>"
                               class="form-control input-lg" style="text-align:left; direction:ltr" id="canonical_url"
                               placeholder="<?php echo  @get_post_url($post); ?>"/>
                        <div style="font-size: 14px; margin-top: 2px">
                ...
                <div class="form-group hidden" style="margin-top:20px">
                    ...
                    <div class="col-sm-7">
                        ...
                        <input type="text"
                               value="<?php echo string_sanitize(Request::old('meta[seo_redirect]', @$post->seo->seo_redirect)) ?>"
                               class="form-control input-lg" style="text-align:left; direction:ltr" id="seo_redirect"
                               placeholder="<?php echo Lang::get('seo::seo.seo_redirect'); ?>"/>
                        <div style="font-size: 14px; margin-top: 2px">
            ...
            <div class="tab-pane fade" id="facebook-tab">
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <input type="text" name="meta[facebook_title]"
                               value="<?php echo string_sanitize(Request::old('meta[facebook_title]', @$post->seo->facebook_title)) ?>"
                               class="form-control input-lg" id="facebook_title"
                               placeholder="<?php echo Lang::get('seo::seo.facebook_title'); ?>"/>
                        <div style="font-size: 14px; margin-top: 2px">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <textarea class="form-control" rows="4" name="meta[facebook_description]"
                                  id="facebook_description" style="resize: vertical"
                                  placeholder="<?php echo Lang::get('seo::seo.facebook_description'); ?>"><?php echo string_sanitize(Request::old('meta[facebook_description]', @$post->seo->facebook_description)) ?></textarea>
                        <div style="font-size: 14px; margin-top: 2px">
            ...
            <div class="tab-pane fade" id="twitter-tab">
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        ...
                        <input type="text" name="meta[twitter_title]"
                               value="<?php echo string_sanitize(Request::old('meta[twitter_title]', @$post->seo->twitter_title)) ?>"
                               class="form-control input-lg" id="twitter_title"
                               placeholder="<?php echo Lang::get('seo::seo.twitter_title'); ?>"/>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <textarea name="meta[twitter_description]" class="form-control" id="twitter_description"
                                  style="resize: vertical" rows="4"
                                  placeholder="<?php echo Lang::get('seo::seo.twitter_description'); ?>"><?php echo string_sanitize(Request::old('meta[twitter_description]', @$post->seo->twitter_description)) ?></textarea>
                        <div style="font-size: 14px; margin-top: 2px">
