        ...
        <div class="row">
            ...
            <div class="card foras">
                <div class="card-header">
                    <div class="row">
                        <div class="col-md-2">
                            <div class="card-img"><a href="{{route('chances.show', ['id' => 1])}}"><img src="{{asset('/assets')}}/images/pic1.png" alt=""></a></div>
                        </div>
                        <div class="col-md-10">
                            <div class="title">
                                <p> الفرصة    <span><a href="{{route('chances.show', ['id' => 1])}}"> نظام IP لمشروع فندقي  </a></span></p>
                                <p>الشركة <span>شركة حمومة المحدوده </span></p>
                            </div>
                        </div>
                    </div>
                ...
                <div class="card-price clearfix">
                    <div class="priceshadow one_half">
                        <button type="button" class="uperc padding-md fbutcenter btn-mas" data-dismiss="modal" data-target="#myModal">تقديم على الفرصه</button>
                        <!-- Modal -->
                    ...
                    <div class="light-white one_half padt">  قيمة الفرصة : <span class="text-blue"> من 20.000 الى 50.000 </span></div>
                </div>
            </div>
            <div class="card foras">
                <div class="card-header">
